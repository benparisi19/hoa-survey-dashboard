-- HOA Survey Dashboard - CORRECTED Marginal Notes Database Setup Commands
-- Run these commands in the Supabase SQL Editor to add the survey_notes table
-- Based on ACTUAL current schema from supabase.ts
...
-- =============================================
-- STEP 5: Update the complete_responses view with CORRECT column names
-- =============================================

-- Drop the existing view
DROP VIEW IF EXISTS complete_responses;

-- Recreate with ACTUAL column names based on current schema
...
SELECT 
    ...
    -- Q8: Equipment (CORRECTED: notes not equipment_notes)
    q8.q8_na,
    q8.lawn_mower,
    q8.trimmer,
    q8.blower,
    q8.basic_tools,
    q8.truck_trailer,
    q8.notes as equipment_notes, -- Alias for consistency
    
    -- Q9: Dues preference (CORRECTED: q9_response and notes)
    q9.q9_response as dues_preference, -- Alias for consistency
    q9.notes as dues_notes, -- Alias for consistency
    
    -- Q10: Biggest concern (CORRECTED: q10_text not biggest_concern)
    q10.q10_text as biggest_concern, -- Alias for consistency
    
    -- Q11: Cost reduction (CORRECTED: q11_text not cost_reduction_ideas)
    q11.q11_text as cost_reduction_ideas, -- Alias for consistency
    
    -- Q12: Involvement (CORRECTED: q12_response and q12_notes)
    q12.q12_response as involvement_preference, -- Alias for consistency
    q12.q12_notes as involvement_notes, -- Alias for consistency
...
-- Test the updated view with notes columns
